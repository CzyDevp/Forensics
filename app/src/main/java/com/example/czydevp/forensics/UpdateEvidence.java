 ...
 */
public class UpdateEvidence extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(UpdateEvidence.this,MyAccount.class);
        ...
        if(item.getItemId()==3)
        {
            Intent cases8 = new Intent(UpdateEvidence.this,Login.class);
        ...
        if(item.getItemId()==2)
        {
            Intent cases8 = new Intent(UpdateEvidence.this,Change.class);
            cases8.putExtra("id",uid);
            startActivity(cases8);
            //finish();
        }
