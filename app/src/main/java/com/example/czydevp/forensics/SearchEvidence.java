 ...
 */
public class SearchEvidence extends Activity {
   // ArrayList<String> items=new ArrayList<String>();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(SearchEvidence.this,MyAccount.class);
        ...
        if(item.getItemId()==3)
        {
            Intent cases8 = new Intent(SearchEvidence.this,Login.class);
        ...
        if(item.getItemId()==2)
        {
            Intent cases8 = new Intent(SearchEvidence.this,Change.class);
            cases8.putExtra("id",uid);
            startActivity(cases8);
            //finish();
        }
