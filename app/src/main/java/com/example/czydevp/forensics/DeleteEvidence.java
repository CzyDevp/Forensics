 ...
 */
public class DeleteEvidence extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(DeleteEvidence.this,MyAccount.class);
        ...
        if(item.getItemId()==3)
        {
            Intent cases8 = new Intent(DeleteEvidence.this,Login.class);
        ...
        if(item.getItemId()==2)
        {
            Intent cases8 = new Intent(DeleteEvidence.this,Change.class);
            startActivity(cases8);
            overridePendingTransition(R.anim.activity_in, R.anim.activity_out);
            //finish();
        }
