...
public class ListEvidence extends Activity {
   ...
   // private boolean flag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   myStatusContentProvider = new MyStatusContentProvider(StatusDetailActivity.this);
        ...
        db = new DBAdapter(this);
           db.open();
        ArrayList array_list = db.getTableValuescase1();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(ListEvidence.this,MyAccount.class);
        ...
        if(item.getItemId()==3)
        {
            Intent cases8 = new Intent(ListEvidence.this,Login.class);
        ...
        if(item.getItemId()==2)
        {
            Intent cases8 = new Intent(ListEvidence.this,Change.class);
            cases8.putExtra("id",uid);
            startActivity(cases8);
            // finish();
        }
