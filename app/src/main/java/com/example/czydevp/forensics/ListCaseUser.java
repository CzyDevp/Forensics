...
public class ListCaseUser extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.open();
        ArrayList array_list = db.getuserall();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(ListCaseUser.this,MyAccount.class);
        ...
        if(item.getItemId()==3)
        {
            Intent cases8 = new Intent(ListCaseUser.this,Login.class);
        ...
        if(item.getItemId()==2)
        {
            Intent cases8 = new Intent(ListCaseUser.this,Change.class);
            cases8.putExtra("id",uid);
            startActivity(cases8);
            // finish();
        }
