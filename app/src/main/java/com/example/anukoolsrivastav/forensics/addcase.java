 ...
 */
public class addcase extends ActionBarActivity implements OnClickListener {
   ...
   // ArrayList<String> items1=new ArrayList<String>();
    ...
    EditText status,loc,dec,tv11,name;
  ...
  DBAdapter db=new DBAdapter(this);
   ...
   actv1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(addcase.this,myaccnt.class);
