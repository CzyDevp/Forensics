...
public class listevdnc extends Activity {
   ...
   // private boolean flag;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(listevdnc.this,myaccnt.class);
        ...
        if(item.getItemId()==3)
        {
            Intent cases8 = new Intent(listevdnc.this,Login.class);
        ...
        if(item.getItemId()==2)
        {
            Intent cases8 = new Intent(listevdnc.this,change.class);
            cases8.putExtra("id",uid);
            startActivity(cases8);
            // finish();
        }
