...
public class investigator extends Activity
{
    ...
    //    Button btn4=(Button) findViewById(R.id.delete_eve);
       ...
       // Toast.makeText(getApplication()," "+a+email+uid+nmbr,Toast.LENGTH_LONG).show();
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cases=new Intent(investigator.this, searchevdnc.class);
                cases.putExtra("user",a);
                cases.putExtra("id",uid);
                cases.putExtra("mail",email);
                cases.putExtra("mobile",nmbr);
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cases=new Intent(investigator.this, upevdnc.class);
                cases.putExtra("user",a);
                cases.putExtra("id",uid);
                cases.putExtra("mail",email);
                cases.putExtra("mobile",nmbr);
      ...
      /*  btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cases=new Intent(investigator.this, delete_evdnc.class);
                cases.putExtra("user",a);
                cases.putExtra("id",uid);
                cases.putExtra("mail",email);
                cases.putExtra("mobile",nmbr);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId()==1)
        {
            Intent cases8 = new Intent(investigator.this,myaccnt.class);
